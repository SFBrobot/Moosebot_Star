...
task autonomous() { // Function that runs the autonomous program.
	...
	arm(0, 350); // Stops the arm.
	standard(127, 127, 400);
	standard(0, 0, 250);
	standard(-127, 127, 300);
	standard(0, 0, 250);
	standard(127, 127, 600);
	standard(0, 0, 250);
	clawMovement(-127, 500);
	clawMovement(0, 50);
	...
	standard(0, 0, 250);	
	clawMovement(127, 200);
	clawMovement(0, 50);
	standard(-127, 127, 250);
	standard(0, 0, 250);	
	clawMovement(127, 200);
	clawMovement(0, 50);
	standard(-127, -127, 100);
	standard(0, 0, 25);
	clawMovement(127, 100);
	clawMovement(0, 50);
	standard(-127, -127, 100);
	standard(0, 0, 25);
	clawMovement(127, 100);
